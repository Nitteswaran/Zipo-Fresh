    ...
    return (
        <footer className="bg-white border-t py-12">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                        ...
                        <li><Link href="/shop?category=fresh-produce" className="hover:text-orange-600">Fresh Produce</Link></li>
                        <li><Link href="/shop?category=meat-poultry" className="hover:text-orange-600">Meat & Poultry</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                        <li><Link href="/order/track" className="hover:text-orange-600">Track Order</Link></li>
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 mb-2">
                        No. 751, Taman Musim Bunga, 31400 Ipoh, Perak.<br />
                        +60 12-206 5295
                    </p>
                    <div className="flex gap-4 mt-4">
                        <a href="https://wa.me/60122605295" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-green-600 transition-colors">
                        ...
                        <a href="https://www.instagram.com/zipo.fresh?igsh=dDF2ZWhzanU1NTRv" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-pink-600 transition-colors">
            ...
            <div className="container mx-auto px-4 mt-12 pt-8 border-t text-center text-sm text-gray-500">
                © {new Date().getFullYear()} Zipo Fresh. All rights reserved.
            </div>
        </footer>
    )
}
